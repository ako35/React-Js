    ...
    <Router>
      <Routes>
        ...
        <Route path="dijital-saat-uygulamasi">
          ...
          <Route
            path="2"
            element={<DijitalSaatUygulamasi2 textColor="white" bgColor="red" />}
          />
          <Route
            path="3"
            element={
        ...
        <Route
          path="profile-card"
          element={<ProfileCard {...profileCardData} />}
        />
        ...
        <Route path="component-turleri">
          ...
          <Route
            path="class-turunde-componentler"
            element={<ClassTurundeComponentler />}
          />
          <Route
            path="fonksiyon-turunde-componentler"
            element={<FonksiyonTurundeComponentler />}
          />
        </Route>
        <Route path="fetch">
